...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Plumbsmart Plumbers",
    phone:     "+27787378559",
    whatsapp:  "+27787378559",
    address:   "Karee Dr, Carlswald North Lifestyle Estate, Midrand, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Plumbsmart Plumbers — Services in midrand",
    description: "Plumbsmart Plumbers provides professional services in Midrand. 3 Google reviews. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Services · Midrand & surrounds",
    heroTitle:  "Professional service — <em>done right.</em>",
    heroLead:   "Plumbsmart Plumbers provides professional services for homes and businesses across Midrand and the surrounding area. Reliable, experienced and locally based.",
    ...
    band: {
      ...
      alt:   "Plumbsmart Plumbers team at work in Midrand",
      text:  "Professional service — reliable, experienced and locally based."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Midrand. Serving the wider area.",
    areasLead:  "We work across Midrand, Vorna Valley, Kyalami and surrounding suburbs for residential and commercial clients.",
